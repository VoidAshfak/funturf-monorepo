...
// `isEventAdmin` lets organizers/co-organizers moderate (delete) any comment.
export default function RulesAndComments({ rules, eventId, isEventAdmin = false }) {
    return (
        <Tabs defaultValue="rules" className="w-full">
            ...
            <TabsContent value="comments">
                <CommentsSection eventId={eventId} isEventAdmin={isEventAdmin} />
            </TabsContent>
        </Tabs>
    )
}