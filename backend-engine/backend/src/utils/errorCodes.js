...
export const ERROR_CODES = Object.freeze({
    ...
    INVITATION_NOT_FOUND:  { code: "INVITATION_NOT_FOUND",  statusCode: 404, message: "No pending invitation found for this match" },
    SELF_MESSAGE_FORBIDDEN:{ code: "SELF_MESSAGE_FORBIDDEN", statusCode: 400, message: "You cannot message yourself" },
    NO_TURF_FOR_ADMIN:     { code: "NO_TURF_FOR_ADMIN",      statusCode: 404, message: "You don't own a turf yet — create one first" },
    PROMO_NOT_FOUND:       { code: "PROMO_NOT_FOUND",        statusCode: 404, message: "Promotion not found" },
    PROMO_CODE_EXISTS:     { code: "PROMO_CODE_EXISTS",      statusCode: 409, message: "A promotion with this code already exists" },
    PROMO_SCOPE_FORBIDDEN: { code: "PROMO_SCOPE_FORBIDDEN",  statusCode: 403, message: "You can only manage promotions for your own turf" },
    ...
    EVENT_NOT_EDITABLE:    { code: "EVENT_NOT_EDITABLE",    statusCode: 409, message: "A completed or cancelled match can no longer be edited" },
    INVALID_PLAYER_LIMITS: { code: "INVALID_PLAYER_LIMITS", statusCode: 400, message: "Player limits are invalid (max must be at least the current squad and not below the minimum)" },
    EVENT_SCHEDULE_LOCKED: { code: "EVENT_SCHEDULE_LOCKED", statusCode: 409, message: "This match's time is set by its attached booking — detach the booking to set a probable time" },
    ...
    BOOKING_NOT_CONFIRMED: { code: "BOOKING_NOT_CONFIRMED", statusCode: 409, message: "Only a confirmed booking can be checked in" },
    ALREADY_CHECKED_IN: { code: "ALREADY_CHECKED_IN", statusCode: 409, message: "This ticket has already been checked in" },
    BOOKING_REF_AMBIGUOUS: { code: "BOOKING_REF_AMBIGUOUS", statusCode: 409, message: "That reference matches more than one booking — scan the QR instead" },
    ...
    // anti-spam / integrity
    TOO_MANY_UNPAID_HOLDS:  { code: "TOO_MANY_UNPAID_HOLDS",  statusCode: 429, message: "You've reached the limit of 4 unpaid holds at this turf. Pay for one or cancel it before holding another slot here" },
